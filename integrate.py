...
class Integrate():
    def __init__(self, output_path, mol_file):
        ...
        p_axis = 'X' if p_axis == 'BXLAO' else 'Y' if p_axis == 'BYLAO' else 'Z'

        self.p_planes = [YZ, XZ] if p_axis == 'Z' else [XZ, XY] if p_axis == 'X' else [YZ, XY]
        ...
        #say, it is Z, there are (at least) two perpendicular planes to the molecule,
        ...
        self.output1 = []
        self.output1.append(line1)
        self.output1.append(line2)
        self.output1.append(10)
        self.output1.append(line3)
        self.output1.append(10)
        self.output1.append(10)
        ...
        self.output2 = []
        self.output2.append(line1)
        self.output2.append(line2)
        self.output2.append(10)
        self.output2.append(line3)
        self.output2.append(10)
        self.output2.append(10)
    ...
    def write_integrate_dia(self) :
        file_name1 = 'integrate_dia_' + axis_enum[p_planes[0][0]] + axis_enum[p_planes[0][1]] + '.inp'
        integrate_dia_file1 = open(output_path + os.sep + file_name1, 'w')

        file_name2 = 'integrate_dia_' + axis_enum[planes[1][0]] + axis_enum[planes[1][1]] + '.inp'
        integrate_dia_file2 = open(output_path + os.sep + file_name2, 'w')
    ...
    def write_integrate_para(self):
        file_name1 = 'integrate_para_' + axis_enum[planes[0][0]] + axis_enum[planes[0][1]] + '.inp'
        integrated_para_file1 = open(output_path + os.sep + file_name1, 'w')

        file_name2 = 'integrate_para_' + axis_enum[planes[1][0]] + axis_enum[planes[1][1]] + '.inp'
        integrated_para_file2 = open( output_path + os.sep + file_name2, 'w')
    ...
    def write_integrate_total(self):
        file_name1 = 'integrate_total_' + axis_enum[planes[0][0]] + axis_enum[planes[0][1]] + '.inp'
        integrated_total_file1 = open(output_path + os.sep + file_name1, 'w')

        file_name2 = 'integrate_total_' + axis_enum[planes[1][0]] + axis_enum[planes[1][1]] + '.inp'
        integrated_total_file2 = open( output_path + os.sep + file_name2, 'w')
